...
ifeval::["{context}" == "operator-reference"]
[role="_abstract"]
The following custom resource definitions (CRDs) are managed by Operator Lifecycle Manager (OLM) and Catalog Operator components in {product-title}. These resources define catalog sources, subscriptions, install plans, and cluster service versions for Operator lifecycle management.
